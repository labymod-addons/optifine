...
public final class OptiFineVersions {
  ...
  public static final OptiFineVersion OPTIFINE_1_19_3 = create("1.19.3", "HD_U_I2_pre5", true);
  public static final OptiFineVersion OPTIFINE_1_19_4 = create("1.19.4", "HD_U_I3_pre10", true);
